"""
Django settings for restless_thunder_40637 project.
...
ROOT_URLCONF = 'restless_thunder_40637.urls'
...
WSGI_APPLICATION = 'restless_thunder_40637.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_thunder_40637 API",
    "DESCRIPTION": "API documentation for restless_thunder_40637 App",
    "VERSION": "v1",
}
